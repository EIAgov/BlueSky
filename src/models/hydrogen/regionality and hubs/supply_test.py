...
data_price = demand_curve(pd.read_csv('h2_price.csv'))
...
# test data
price = {(7, 2025): 4.2, (7, 2026): 4.5}
demand = {(7, 2025): 400000, (7, 2026): 500000}
...
#
model = regions.Model(grid, mode='integrated', demand=demand, electricity_price=price)
