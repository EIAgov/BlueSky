...
class Sets:
    ...
    def __init__(self,years,regions):
        ...
        #Scenario Descriptor
        setup_table = pd.read_csv('C:/Users/MLJ/Downloads/ECM Simple/input/scedes.csv',index_col=0)
        ...
        r_file = pd.read_csv('C:/Users/MLJ/Downloads/ECM Simple/input/r_can_line.csv')
        ...
        pt_subsets = Subsets()
        load_and_assign_subsets('C:/Users/MLJ/Downloads/ECM Simple/input/pt_subsets.csv', pt_subsets)
...
def preprocessor(setin,dir):
    ...
    if db_switch == 0:
        ...
        db_dir = 'C:/Users/MLJ/Downloads/ECM Simple/input/cem_inputs_database.db'
...
if __name__ == "__main__":
    ...
    makedir('C:/Users/MLJ/Downloads/ECM Simple/output/inputs/')
    makedir('C:/Users/MLJ/Downloads/ECM Simple/output/temp/')    

    years = list(pd.read_csv('C:/Users/MLJ/Downloads/ECM Simple/input/sw_year.csv').dropna()['year'])
    regions = list(pd.read_csv('C:/Users/MLJ/Downloads/ECM Simple/input/sw_reg.csv').dropna()['region'])
    ...
    all_frames, setB = preprocessor(setA,'C:/Users/MLJ/Downloads/ECM Simple/input/cem_inputs/')
    for key in all_frames:
        all_frames[key].to_csv('C:/Users/MLJ/Downloads/ECM Simple/output/inputs/'+key+'.csv')

    #reviews current test data
    all_frames = {}
    all_frames, setC = preprocessor(setA,'C:/Users/MLJ/Downloads/ECM Simple/input/temp/')
    for key in all_frames:
        all_frames[key].to_csv('C:/Users/MLJ/Downloads/ECM Simple/output/temp/'+key+'.csv')

    new = {}
    for filename in os.listdir('C:/Users/MLJ/Downloads/ECM Simple/output/temp/'):
        #print(filename[:-4])
        f = os.path.join('C:/Users/MLJ/Downloads/ECM Simple/output/temp/', filename)
        if os.path.isfile(f):
            new[filename[:-4]] = pd.read_csv(f)

    old = {}
    for filename in os.listdir('C:/Users/MLJ/Downloads/ECM Simple/output/inputs/'):
        #print(filename[:-4])
        f = os.path.join('C:/Users/MLJ/Downloads/ECM Simple/output/inputs/', filename)
        if os.path.isfile(f):
