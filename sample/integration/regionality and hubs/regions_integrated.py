...
class Data:
    ...
    def __init__(self):
        ...
        '''
        #self.regions = pd.read_csv('C:/Users/MLJ/Downloads/H2/regionality and hubs/regions.csv', index_col = False)
        self.hubs = pd.read_csv('C:/Users/MLJ/Downloads/H2/regionality and hubs/hubs.csv', index_col = False)
        self.arcs = pd.read_csv('C:/Users/MLJ/Downloads/H2/regionality and hubs/transportation_arcs.csv', index_col = False)
...
class Functions:
    ...
    def get_production_cost(self,m, hub,tech,year):   
        ...
        if self.mode == 'standard':
            ...
            #elif tech == 'SMR': return m.gas_price[self.model.hubs[hub].region.name,year] + m.electricity_price[self.model.hubs[hub].region.name,year]*m.electricity_consumption_rate[tech]
            if tech == 'PEM': return electricity_price[self.model.hubs[hub].region.name,year]*m.electricity_consumption_rate[tech]
            elif tech == 'SMR': return m.gas_price[self.model.hubs[hub].region.name,year] + electricity_price[self.model.hubs[hub].region.name,year]*m.electricity_consumption_rate[tech]
...
class Model:
    ...
    def generate_parameters(self,m):
        ...
        m.electricity_consumption_rate = Param(m.technology, initialize = self.electricity_consumption_rate)
